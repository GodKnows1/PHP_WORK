...
<body>
	<div id="container">
		...
		<ul>
			...
			<li><a class="active" href="featured.php">Featured Recipes</a></li>
		...
		<div id="main">
			...
			<ul class="services">
				<li>
					...
					<a id="getUser" data-value="masala dosa">Read More</a>
				</li>
				...
				<li>
					...
					<a href="showrecipe.php" data-value="french toast">Read More</a>
				</li>
				...
				<li>
					...
					<a href="showrecipe.php" data-value="lasagna">Read More</a>
				</li>
				...
				<li>
					...
					<a href="showrecipe.php">Read More</a>
				</li>
    ...
    <div id="userInfo" >jnnjbvvfngbkjn</div>
     <p id="ppp"></p>
    <script>
